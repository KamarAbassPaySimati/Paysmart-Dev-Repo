...
data class MerchantRequestResponse(
    @SerializedName("data")
    val paymerchant:MerchantPayResponse,
...
data class MerchantPayResponse(
    ...
    companion object CREATOR : Parcelable.Creator<MerchantPayResponse> {
        override fun createFromParcel(parcel: Parcel): MerchantPayResponse {
            return MerchantPayResponse(parcel)
        }

        override fun newArray(size: Int): Array<MerchantPayResponse?> {
