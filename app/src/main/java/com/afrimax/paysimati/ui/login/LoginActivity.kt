package com.afrimax.paysimati.ui.login
...
import com.afrimax.paysimati.common.presentation.ui.text_field.phone.PhoneField
import com.afrimax.paysimati.databinding.ActivityLoginBinding
import com.afrimax.paysimati.ui.password.ForgotPasswordPinActivity
...
class LoginActivity : AppCompatActivity(), LoginByDialogInterface {
    ...
    override fun onSelection(selectionId: String) {
        when (selectionId) {
            ...
            Constants.SELECTION_PAYMAART_ID -> {
                b.loginActivityLoginByTV.text = getString(R.string.paysimati_id)
                b.loginActivityPhoneTF.visibility = View.GONE
                b.loginActivityEmailContainer.visibility = View.GONE
    ...
    private fun validateFieldsForSubmit() {
        ...
        when (loginBy) {
            ...
            getString(R.string.paysimati_id) -> loginByField = b.loginActivityPaymaartIdET
        }
    ...
    private fun validatePaymaartId(paymaartIdEditText: EditText, warningText: TextView): Boolean {
        ...
        if (paymaartIdEditText.text.isEmpty()) {
            ...
            isValid = false
            showPaymaartIdWarning(getString(R.string.invalid_paysimati_id))
        } else {
    ...
    private fun validatePaymaartIdAndPin() {
        ...
        if (isValidPaymaartId && isValidPin) {
            val paymaartId =
                getString(R.string.paysimati_code) + b.loginActivityPaymaartIdET.text.toString()
            val pin = b.loginActivityPinET.text.toString()
            amplifyStartLogIn(
