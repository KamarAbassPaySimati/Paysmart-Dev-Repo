...
class PayMerchantActivity : BaseActivity() {
    ...
    private fun validateAmount() {
        ...
        when {
            amount.isEmpty() -> {
                ...
                binding.payMerchantActivityPaymentErrorTV.text = getString(R.string.please_enter_amount)
            }
    ...
    private fun getTaxAndVatForMerchantTransaction(amount: Double) {
        showbuttonloader(
            binding.payMerchantActivitySendPaymentButton,binding.payMerchantActivitySendPaymentButtonLoaderLottie
        )
