Feature: Paymaart- Customer Android- Edit Self KYC Details(Non-Malawi)Paymaart- Customer Android- Edit Self KYC Details(Non-Malawi)
  ...
  Scenario: Customer editing KYC details
    ...
    When I select the ID document as "Refugee ID" for editing self kyc
