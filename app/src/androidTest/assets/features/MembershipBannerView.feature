Feature: Paymaart- Customer Android- Membership banner view(first time)
  As a Customer, I want an option to view a banner of subscription so that I can purchase the membership
  Condition of satisfaction
  When accessing the subscription management interface, user should see the following options for subscription duration: "Monthly (30-day)" and "91-day."
  Users should be able to view the details and benefits associated with each subscription duration option, including any specific features or services offered.
  3.Users should be able to select their preferred subscription duration from the available options.
  4.If a user chooses the "Monthly (30-day)" subscription, they should be billed monthly, and their subscription will automatically renew every 30 days, subject to the availability of funds in their Paymaart wallet.
  5.If a user chooses the "91-day" subscription, they should be billed for 91 days, and their subscription will automatically renew every 91 days, subject to the availability of funds in their Paymaart wallet.
  The auto-renewal feature should be optional and enabled by default for customers who choose a subscription duration.
