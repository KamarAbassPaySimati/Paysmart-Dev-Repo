Feature: Paymaart- Customer Android- View KYC Details (Simplified )
  ...
  Scenario: I should be able to view the KYC details
    ...
    Then I should see a preview of uploaded "Employer Letter Front.jpg"
    When I close full screen preview screen
    ...
    And I should see monthly withdrawal and monthly income as Up to 300,000.00 MWK