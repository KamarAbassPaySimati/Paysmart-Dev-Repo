Feature: Paymaart- Customer Android- Make Payment to Customer
  ...
  The system should mask the phone number for those members not available in user phone contacts, else phone number to be shown.
  The payment should be associated with the identified recipient based on the provided telephone number, even if they are not a registered Paymaart user.
