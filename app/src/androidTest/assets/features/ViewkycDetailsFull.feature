Feature: Paymaart- Customer Android- View KYC Details(Full)
  ...
  Scenario: I should be able to view the KYC details
    ...
    Then I should see a preview of uploaded "National ID Front.jpg"
    ...
    Then I should see a preview of uploaded "Birth Certificate Front.jpg"
    When I close full screen preview screen
